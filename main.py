...
class FitnessCoachApp(QMainWindow):
    ...
    def stop_exercise(self):
        ...
        self.last_rep_count = 0
        # Manteniamo target_reps per mostrare l'obiettivo raggiunto
    ...
    def update_feedback_and_reps(self, feedback_text=None, rep_count=None):
        ...
        if target > 0:
            if actual_reps >= target:
                ...
                # Breve pausa prima di terminare
    ...
    def update_frame(self):
        # Non procedere se l'allenamento è stato interrotto
        ...
        # Prepara il frame per l'analisi
        ...
        # Analizza la postura se sono stati rilevati i punti del corpo
        if landmarks and len(landmarks) > 0:
            ...
            # Gestione quando non sono rilevati punti del corpo
        ...
        # Visualizza il frame con i punti di riferimento
